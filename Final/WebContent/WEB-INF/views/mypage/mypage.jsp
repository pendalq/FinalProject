...
<div class="mypageTable">
   <div style="margin-top: 50px; width:15%; position: relative; left: 1254px">
      ${sessionScope.loginID }님 환영합니다 <button type="button" class="btn btn-outline-danger" id="memInfoUpdate">회원정보수정</button>
   </div>
...
<h2 style="text-align: center; margin-top: 10px">문의한 게시판</h2>
<!-- 리스트 -->
