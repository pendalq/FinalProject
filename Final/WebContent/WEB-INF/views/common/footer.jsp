<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div>
        ...
        <!-- Start Footer Area -->
        <footer class="htc__foooter__area" style="background: rgba(0, 0, 0, 0) url(image/footer_ss.png) no-repeat scroll center center / cover ;">
            <div class="container">
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            <div class="copyright__inner">
                                ...
                                <ul class="footer__menu">
                                    <li><a href="mainbbslist.do">Home</a></li>
