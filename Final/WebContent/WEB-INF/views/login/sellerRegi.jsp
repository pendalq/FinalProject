		...
		<div class="UserRegitb">
			<table style="width: 100%; border: 1px solid #ddd;" >
				...
				<tr>
					<th>사업장 연락처</th>
					<td>
						<input type="text" name="phone" id="_phone" size="10" data-msg="사업장 연락처를 " placeholder="사업장 연락처" autofocus required maxlength="13">
					</td>	
				</tr>
				<tr>
					<th>사업장 주소</th>
					<td>
						<input type="text" name="address" id="_address" size="60" data-msg="사업장 주소를 " placeholder="사업장 주소">
						<input type="button" onclick="execDaumPostcode()" value="주소 검색" src="img/" ><br>
