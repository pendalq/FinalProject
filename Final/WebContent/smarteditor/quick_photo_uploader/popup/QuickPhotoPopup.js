    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'http://localhost:8090/final/smarteditor/popup/FileUploader_html5.php'; 	//upload URL
     ...
     */
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'http://localhost:8090/final/smarteditor/popup/quick_photo/FileUploader.php',	//샘플 URL입니다.
