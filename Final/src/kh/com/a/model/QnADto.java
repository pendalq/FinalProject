...
public class QnADto implements Serializable{
   ...
   public QnADto(int seq,String category ,String id, String title, String content, int ref, int step, int dept, String wdate,
         int del) {
      super();
      this.seq = seq;
   ...
   public String toString() {
      return "QnADto [seq=" + seq + ", category=" + category + ", id=" + id + ", title=" + title + ", content="
            + content + ", ref=" + ref + ", step=" + step + ", dept=" + dept + ", wdate=" + wdate + ", del=" + del
            + "]";
   }
